...
iMPS, val_metric = pfaffian.H_to_iMPS(H_short, H_long, trunc_par, cell, cut, basis="M")
print("Error metric:", val_metric)

# check overlap after inserting more unit cells
n_cell = 8

mps_short = pfaffian.H_to_MPS(H_short, trunc_par, basis="M")

H_vlong = H(L_short + n_cell * cell)
mps_vlong = pfaffian.H_to_MPS(H_vlong, trunc_par, basis="M")
